#!/usr/bin/env python3
"""Render committed benchmark JSON into a readable RESULTS.md per chapter.
...
Usage:
    python scripts/render_results.py            # regenerate
    python scripts/render_results.py --check    # exit 1 if regeneration would change anything
"""
import argparse
import json
import re
...
def load_results():
    ...
    for path in sorted(ROOT.glob("chapter-*/benchmarks/results/*.json")):
